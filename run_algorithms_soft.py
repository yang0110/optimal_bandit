...
plt.tight_layout()
plt.savefig(path+'simu_regret_shadow_soft_d_%s'%(dimension)+'.png', dpi=300)
plt.show()
...
plt.figure(figsize=(5,5))
plt.plot(x, offline_prob_mean_5, '-o', color='r', linewidth=2, markevery=0.1, markersize=5, label='ExpUCB (offline), d = 5')
plt.fill_between(x, offline_prob_mean_5-offline_prob_std_5*0.95, offline_prob_mean_5+offline_prob_std_5*0.95, color='r', alpha=0.2)
plt.plot(x, online_prob_mean_5, '-*', color='orange', linewidth=2, markevery=0.1, markersize=5, label='ExpUCB (online), d = 5')
plt.fill_between(x, online_prob_mean_5-online_prob_std_5*0.95, online_prob_mean_5+online_prob_std_5*0.95, color='orange', alpha=0.2)
plt.plot(x, offline_prob_mean_10, '-p', color='pink', linewidth=2, markevery=0.1, markersize=5, label='ExpUCB (offline), d = 10')
plt.fill_between(x, offline_prob_mean_10-offline_prob_std_10*0.95, offline_prob_mean_10+offline_prob_std_10*0.95, color='pink', alpha=0.2)
plt.plot(x, online_prob_mean_10, '-|', color='y', linewidth=2, markevery=0.1, markersize=5, label='ExpUCB (online), d = 10')
plt.fill_between(x, online_prob_mean_10-online_prob_std_10*0.95, online_prob_mean_10+online_prob_std_10*0.95, color='y', alpha=0.2)
plt.legend(loc=4, fontsize=12)
plt.xlabel('Time', fontsize=14)
plt.ylabel('Beta', fontsize=14)
plt.tight_layout()
plt.savefig(path+'simu_online_offline_prob'+'.png', dpi=300)
plt.show()
...
# for i in range(item_num):
# 	if i==best_arm:
# 		plt.plot(x, exp3_prob_matrix[i], '-', color='c', markevery=0.2, linewidth=2, markersize=8, label='Best Arm')
# 	else:
# 		plt.plot(x, exp3_prob_matrix[i], '-', color='gray', markevery=0.2, linewidth=2, markersize=5)
# plt.legend(loc=4, fontsize=12)
# plt.ylim([-0.15,1.1])
# plt.xlabel('Time', fontsize=12)
# plt.ylabel('Probability', fontsize=12)
# plt.tight_layout()
# plt.savefig(path+'exp3_prob_matrix'+'.png', dpi=300)
# plt.show()
