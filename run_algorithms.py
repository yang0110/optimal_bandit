...
lse_model=LSE(dimension, iteration, item_num, user_feature, item_feature, true_payoffs, alpha, delta, sigma, lambda_)

m_eli_model=M_ELI(dimension, phase_num, item_num, user_feature,item_feature, true_payoffs, alpha, delta, sigma, lambda_)
#####################
...
lse_regret, lse_error, lse_item_index, lse_hist_low_matrix, lse_hist_upper_matrix=lse_model.run(iteration)

m_eli_regret, m_eli_error, m_eli_item_index, m_eli_hist_low_matrix, m_eli_hist_upper_matrix=m_eli_model.run(iteration)
...
plt.tight_layout()
plt.savefig(path+'se_payoff_interval_each_arm'+'.png', dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig(path+'lse_payoff_interval_each_arm'+'.png', dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig(path+'eliminator_payoff_interval_each_arm'+'.png', dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig(path+'m_eliminator_payoff_interval_each_arm'+'.png', dpi=200)
plt.show()
