...
class SE_TEST():
	...
	def run(self, iteration):
		...
		for time in range(iteration):
			print('time/iteration, %s/%s, item_num=%s ~~~~ SE-Test'%(time, iteration, len(self.item_set)))
		...
		return cum_regret, error, self.item_index, self.x_norm_matrix, self.hist_low_matrix, self.hist_upper_matrix
