...
plt.plot(x, beta_mean_10, '-.', color='r', markevery=0.1, markersize=5, linewidth=2, label='d=10')
...
plt.plot(x, regret_mean_10, '-.', color='r', markevery=0.1, markersize=5, linewidth=2, label='d=10')
